...
public class CreditHistoryActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (proctorId != null) {
                        ...
                        Toast.makeText(CreditHistoryActivity.this, "Proctor ID not found", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(CreditHistoryActivity.this, "No data found for user", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CreditHistoryActivity.this, "Error fetching proctor ID: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void fetchCreditHistory() {
        ...
        creditHistoryRef.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CreditHistoryActivity.this, "Error fetching credit history: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
